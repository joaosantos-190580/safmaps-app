...
$("#tab-uco-residues").click(function(e) {
    ...
    // Load layers groups
    group_1 = ['DBMS:uco_potential_availability_agroicone'];
...
// Pop-up de alerta - UCO (Layer)
$('#popper-uco').hover(function() {
    $( "#alert-uco" ).toggle();
});

// INFRASTRUCTURE
// toggle-roads (Layer)
$("#toggle-roads_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    $('#toggle-railroads_fd_09').prop('checked', false);
    $('#toggle-pipelines_fd_09').prop('checked', false);
    $('#toggle-waterways_fd_09').prop('checked', false);
    //reset_all_legends();
...
$("#toggle-railroads_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    $('#toggle-roads_fd_09').prop('checked', false);
    $('#toggle-pipelines_fd_09').prop('checked', false);
    $('#toggle-waterways_fd_09').prop('checked', false);
    //reset_all_legends();
    removeLayers_group("gp_2");
...
$("#toggle-pipelines_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    $('#toggle-roads_fd_09').prop('checked', false);
    $('#toggle-railroads_fd_09').prop('checked', false);
    $('#toggle-waterways_fd_09').prop('checked', false);
...
$("#toggle-waterways_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    $('#toggle-roads_fd_09').prop('checked', false);
    $('#toggle-railroads_fd_09').prop('checked', false);
    $('#toggle-pipelines_fd_09').prop('checked', false);
...
$("#toggle-airports_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    //reset_all_legends();
    //removeLayers();
...
$("#toggle-refineries_refining_fd_09").on('change', function(){
    //$('input:checkbox').not(this).prop('checked', false);
    //reset_all_legends();
    //removeLayers();
...
// INFRASTRUCTURE
// toggle-roads (Layer)
$("#info-roads_fd_09").click(function(e) {
    e.preventDefault();
...
// info-railroads_fd_09
$("#info-railroads_fd_09").click(function(e) {
    e.preventDefault();
...
// info-pipelines_fd_09
$("#info-pipelines_fd_09").click(function(e) {
    e.preventDefault();
...
// info-waterways_fd_09
$("#info-waterways_fd_09").click(function(e) {
    e.preventDefault();
...
// info-airports_fd_09
$("#info-airports_fd_09").click(function(e) {
    e.preventDefault();
...
// info-refineries_refining_fd_09
$("#info-refineries_refining_fd_09").click(function(e) {
    e.preventDefault();
